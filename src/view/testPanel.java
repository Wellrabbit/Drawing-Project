...
public class testPanel extends JPanel
{
	...
	public ArrayList<Rectangle> getRecatngleList()
	{
		return RecatngleList;
	}

	public ArrayList<Ellipse2D> getEllipseList()
	{
		return ellipseList;
	}

	public ArrayList<Ellipse2D> getCircleList()
	{
		return CircleList;
	}

	public ArrayList<Polygon> getTriangleList()
	{
		return triangleList;
	}
